...
-- Records of offerpro
-- ----------------------------
INSERT INTO `offerpro` VALUES (1, 34, 14, 100000, 0, '2020-01-02 05:06:29');
INSERT INTO `offerpro` VALUES (2, 34, 14, 150000, 1, '2020-01-02 05:13:38');
...
CREATE TABLE `prodetails`  (
  `ProDeID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `ProID` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `prodetails` VALUES (1, 34, '<ul>\r\n<li>&nbsp;Name: `Laptop Dell Vostro V5481A P92G001(i5 8265U / 4GB RAM / 1TB HDD / MX130 2G / 14\" FHD/Win 10)`,</li>\r\n<li>&nbsp;Chipset: \"Bộ vi xử l&yacute; Intel Core&trade; i5 8265U (1.6Ghz, 6MB Cache)\"</li>\r\n<li>&nbsp;Rom: \"Bộ nhớ trong 4GB DDR4 2666MHz\"</li>\r\n<li>&nbsp;GraphicCard: \"VGA Nvidia Geforce MX130 2G DDR5\",</li>\r\n<li>HardDriver: \"Ổ cứng 1TB 5400rpm\",</li>\r\n<li>Screen: \"M&agrave;n h&igrave;nh 14.0&rdquo; FHD(1920 * 1080), LED backlight&nbsp;</li>\r\n</ul>\r\n<div id=\"eJOY__extension_root\" style=\"all: unset;\">&nbsp;</div>', '2019-12-30 16:59:41', 0);
INSERT INTO `prodetails` VALUES (2, 34, '<ul>\r\n<li>&nbsp;Chipset: \"Bộ vi xử l&yacute; Intel Core&trade; i5 8265U (1.6Ghz, 6MB Cache)\"</li>\r\n<li>&nbsp;Rom: \"Bộ nhớ trong 4GB DDR4 2666MHz\"</li>\r\n<li>Screen: \"M&agrave;n h&igrave;nh 14.0&rdquo; FHD(1920 * 1080), LED backlight&nbsp;</li>\r\n</ul>\r\n<div id=\"eJOY__extension_root\" style=\"all: unset;\">&nbsp;</div>', '2020-01-05 16:59:41', 1);
INSERT INTO `prodetails` VALUES (4, 35, '<ul>\r\n<li>&nbsp;Name: `Laptop Dell Vostro V5481A P92G001(i5 8265U / 4GB RAM / 1TB HDD / MX130 2G / 14\" FHD/Win 10)`,</li>\r\n<li>&nbsp;Chipset: \"Bộ vi xử l&yacute; Intel Core&trade; i5 8265U (1.6Ghz, 6MB Cache)\"</li>\r\n<li>&nbsp;Rom: \"Bộ nhớ trong 4GB DDR4 2666MHz\"</li>\r\n<li>&nbsp;GraphicCard: \"VGA Nvidia Geforce MX130 2G DDR5\",</li>\r\n<li>HardDriver: \"Ổ cứng 1TB 5400rpm\",</li>\r\n<li>Screen: \"M&agrave;n h&igrave;nh 14.0&rdquo; FHD(1920 * 1080), LED backlight&nbsp;</li>\r\n</ul>\r\n<div id=\"eJOY__extension_root\" style=\"all: unset;\">&nbsp;</div>', '2020-01-15 16:59:41', 1);
INSERT INTO `prodetails` VALUES (5, 34, '<ul>\r\n<li>&nbsp;Chipset: \"Bộ vi xử l&yacute; Intel Core&trade; i5 8265U (1.6Ghz, 6MB Cache)\"</li>\r\n<li>&nbsp;Rom: \"Bộ nhớ trong 4GB DDR4 2666MHz\"</li>\r\n<li>Screen: \"M&agrave;n h&igrave;nh 14.0&rdquo; FHD(1920 * 1080), LED backlight&nbsp;</li>\r\n</ul>\r\n<div id=\"eJOY__extension_root\" style=\"all: unset;\">&nbsp;</div>', '2019-12-30 10:59:41', 0);
INSERT INTO `prodetails` VALUES (6, 34, '<ul>\r\n<li>&nbsp;GraphicCard: \"VGA Nvidia Geforce MX130 2G DDR5\",</li>\r\n<li>HardDriver: \"Ổ cứng 1TB 5400rpm\",</li>\r\n<li>Screen: \"M&agrave;n h&igrave;nh 14.0&rdquo; FHD(1920 * 1080), LED backlight&nbsp;</li>\r\n</ul>\r\n<div id=\"eJOY__extension_root\" style=\"all: unset;\">&nbsp;</div>', '2020-05-20 11:59:41', 1);
...
CREATE TABLE `products`  (
  ...
  `StatusAcceptFromAdmin` int(11) NULL DEFAULT NULL,
...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES (34, NULL, 'Dell Vostro 3580', 50000, 50000, 15000000, '2019-12-30 16:59:41', '2020-01-02 21:00:00', 14, NULL, 1, 0);
INSERT INTO `products` VALUES (36, NULL, 'Dell Vostro 3580', 50000, 500, 30000000, '2019-12-30 16:59:41', '2020-01-02 21:00:00', 14, NULL, NULL, 1);
